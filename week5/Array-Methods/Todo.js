...
let user3ToDos = userList.filter((user) => user.userId === 3);
console.log(user3ToDos);

// then find the number of user 3's incomplete tasks
let incompleteTasks = user3ToDos.filter((item) => item.completed !== true);
console.log(`User 3 has ${incompleteTasks.length} incompleted tasks`);
